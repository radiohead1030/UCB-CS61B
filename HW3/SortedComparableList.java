...
public class SortedComparableList {
    ...
    public void extend(SortedComparableList that) {
	    if (that != null){
		    ...
		    SortedComparableList currThat = that.tail;
		    while(currThat != null){
			    this.insert(currThat.head);
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
	    ...
	    if(subL == null || len == 0){
		    ...
		    SortedComparableList sublistL = new SortedComparableList(subL.head, null);
		    SortedComparableList tmp = sublistL;
		    len --;
		    while(subL.tail != null && len > 0){
			    subL = subL.tail;
			    tmp.tail = new SortedComparableList(subL.head, null);
			    tmp = tmp.tail;
			    len --;	    
		    }
		    return sublistL;
    ...
    public void squish() {
	    if(this != null){
		    ...
		    while(curr.tail != null){
			    while(curr.head.compareTo(curr.tail.head) == 0){
